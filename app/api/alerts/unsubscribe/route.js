    ...
    return new Response(
      ...
      <html lang="de">
        <head>
          ...
          <title>Benachrichtigung abbestellt</title>
          <style>
        ...
        <body>
          <main>
            <h1>Benachrichtigung abbestellt</h1>
            <p>Diese KhalfaJobs E-Mail-Benachrichtigung wurde deaktiviert. Sie erhalten dafuer keine weiteren automatischen Stellenangebote.</p>
          </main>
        </body>
      </html>`,
      {
